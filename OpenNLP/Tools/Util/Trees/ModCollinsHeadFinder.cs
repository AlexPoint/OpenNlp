 ...
 */
  ...
  public ModCollinsHeadFinder(AbstractTreebankLanguagePack tlp): base(tlp, tlp.punctuationTags()) {
    ...
    nonTerminalInfo.Add("ADJP", new String[][] { new string[] { "left", "$" }, new string[] { "rightdis", "NNS", "NN", "JJ", "QP", "VBN", "VBG" }, new string[] { "left", "ADJP" }, new string[] { "rightdis", "JJP", "JJR", "JJS", "DT", "RB", "RBR", "CD", "IN", "VBD" }, new string[] { "left", "ADVP", "NP" } });
    nonTerminalInfo.Add("JJP", new String[][] { new string[] { "left", "NNS", "NN", "$", "QP", "JJ", "VBN", "VBG", "ADJP", "JJP", "JJR", "NP", "JJS", "DT", "FW", "RBR", "RBS", "SBAR", "RB" } });  // JJP is introduced for NML-like adjective phrases in Vadas' treebank; Chris wishes he hadn't used JJP which should be a POS-tag.
    // ADVP rule rewritten by Chris in Nov 2010 to be rightdis.  This is right! JJ.* is often head and rightmost.
    nonTerminalInfo.Add("ADVP", new String[][]{new string[]{"left", "ADVP", "IN"},
    ...
    nonTerminalInfo.Add("NAC", new String[][] { new string[] { "left", "NN", "NNS", "NML", "NNP", "NNPS", "NP", "NAC", "EX", "$", "CD", "QP", "PRP", "VBG", "JJ", "JJS", "JJR", "ADJP", "JJP", "FW" } });
    ...
    nonTerminalInfo.Add("PP", new String[][] { new string[] { "right", "IN", "TO", "VBG", "VBN", "RP", "FW", "JJ", "SYM" }, new string[] { "left", "PP" } });

    nonTerminalInfo.Add("PRN", new String[][] { new string[] { "left", "VP", "NP", "PP", "SQ", "S", "SINV", "SBAR", "ADJP", "JJP", "ADVP", "INTJ", "WHNP", "NAC", "VBP", "JJ", "NN", "NNP" } });
    nonTerminalInfo.Add("PRT", new String[][] { new string[] { "right", "RP" } });
    // add '#' for pounds!!
    nonTerminalInfo.Add("QP", new String[][] { new string[] { "left", "$", "IN", "NNS", "NN", "JJ", "CD", "PDT", "DT", "RB", "NCD", "QP", "JJR", "JJS" } });
    ...
    nonTerminalInfo.Add("RRC", new String[][] { new string[] { "left", "RRC" }, new string[] { "right", "VP", "ADJP", "JJP", "NP", "PP", "ADVP" } });

    // delete IN -- go for main part of sentence; add FRAG

    nonTerminalInfo.Add("S", new String[][] { new string[] { "left", "TO", "VP", "S", "FRAG", "SBAR", "ADJP", "JJP", "UCP", "NP" } });
    nonTerminalInfo.Add("SBAR", new String[][] { new string[] { "left", "WHNP", "WHPP", "WHADVP", "WHADJP", "IN", "DT", "S", "SQ", "SINV", "SBAR", "FRAG" } });
    nonTerminalInfo.Add("SBARQ", new String[][] { new string[] { "left", "SQ", "S", "SINV", "SBARQ", "FRAG", "SBAR" } });
    ...
    nonTerminalInfo.Add("SINV", new String[][] { new string[] { "left", "VBZ", "VBD", "VBP", "VB", "MD", "VBN", "VP", "S", "SINV", "ADJP", "JJP", "NP" } });
    nonTerminalInfo.Add("SQ", new String[][] { new string[] { "left", "VBZ", "VBD", "VBP", "VB", "MD", "AUX", "AUXG", "VP", "SQ" } });  // TODO: Should maybe put S before SQ for tag questions. Check.
    ...
    nonTerminalInfo.Add("VP", new String[][] { new string[] { "left", "TO", "VBD", "VBN", "MD", "VBZ", "VB", "VBG", "VBP", "VP", "AUX", "AUXG", "ADJP", "JJP", "NN", "NNS", "JJ", "NP", "NNP" } });
    nonTerminalInfo.Add("WHADJP", new String[][] { new string[] { "left", "WRB", "WHADVP", "RB", "JJ", "ADJP", "JJP", "JJR" } });
    ...
    nonTerminalInfo.Add("X", new String[][] { new string[] { "right", "S", "VP", "ADJP", "JJP", "NP", "SBAR", "PP", "X" } });
    nonTerminalInfo.Add("NP", new String[][] { new string[] { "rightdis", "NN", "NNP", "NNPS", "NNS", "NML", "NX", "POS", "JJR" }, new string[] { "left", "NP", "PRP" }, new string[] { "rightdis", "$", "ADJP", "JJP", "PRN", "FW" }, new string[] { "right", "CD" }, new string[] { "rightdis", "JJ", "JJS", "RB", "QP", "DT", "WDT", "RBR", "ADVP" } });
    ...
    nonTerminalInfo.Add("TYPO", new String[][]{new string[]{"left", "NN", "NP", "NML", "NNP", "NNPS", "TO",
      "VBD", "VBN", "MD", "VBZ", "VB", "VBG", "VBP", "VP", "ADJP", "JJP", "FRAG"}}); // for Brown (Roger)
    nonTerminalInfo.Add("ADV", new String[][]{new string[]{"right", "RB", "RBR", "RBS", "FW",
    ...
    nonTerminalInfo.Add("VB", new String[][] { new string[] { "left", "TO", "VBD", "VBN", "MD", "VBZ", "VB", "VBG", "VBP", "VP", "AUX", "AUXG", "ADJP", "JJP", "NN", "NNS", "JJ", "NP", "NNP" } });

    nonTerminalInfo.Add("META", new String[][] { new string[] { "left" } });  // rule for OntoNotes, but maybe should just be deleted in TreeReader??
    nonTerminalInfo.Add("XS", new String[][] { new string[] { "right", "IN" } }); // rule for new structure in QP, introduced by Stanford in QPTreeTransformer
