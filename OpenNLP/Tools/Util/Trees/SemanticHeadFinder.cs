 ...
 */
  ...
  private static readonly String[] auxiliaries = {"will", "wo", "shall", "sha", "may", "might", "should", "would", "can", "could", "ca", "must", "has", "have", "had", "having", "get", "gets", "getting", "got", "gotten", "do", "does", "did", "to", "'ve", "ve", "v", "'d", "d", "'ll", "ll", "na", "of", "hav", "hvae", "as" };
  private static readonly String[] beGetVerbs = {"be", "being", "been", "am", "are", "r", "is", "ai", "was", "were", "'m", "m", "'re", "'s", "s", "art", "ar", "get", "getting", "gets", "got"};
  public static readonly String[] copulaVerbs = {"be", "being", "been", "am", "are", "r", "is", "ai", "was", "were", "'m", "m", "ar", "art", "'re", "'s", "s", "wase"};
  ...
  private void ruleChanges() {
    ...
    nonTerminalInfo.Add("NP", new String[][]{new string[]{"rightdis", "NN", "NNP", "NNPS", "NNS", "NX", "NML", "JJR", "WP" }, new string[]{"left", "NP", "PRP"}, new string[]{"rightdis", "$", "ADJP", "FW"}, new string[]{"right", "CD"}, new string[]{"rightdis", "JJ", "JJS", "QP", "DT", "WDT", "NML", "PRN", "RB", "RBR", "ADVP"}, new string[]{"rightdis", "VP", "VB", "VBZ", "VBD", "VBP"}, new string[]{"left", "POS"}});
    ...
    nonTerminalInfo.Add("WHNP", new String[][]{new string[]{"rightdis", "NN", "NNP", "NNPS", "NNS", "NX", "NML", "JJR", "WP"}, new string[]{"left", "WHNP", "NP"}, new string[]{"rightdis", "$", "ADJP", "PRN", "FW"}, new string[]{"right", "CD"}, new string[]{"rightdis", "JJ", "JJS", "RB", "QP"}, new string[]{"left", "WHPP", "WHADJP", "WP$", "WDT"}});
    //WHADJP
    nonTerminalInfo.Add("WHADJP", new String[][]{new string[]{"left", "ADJP", "JJ", "JJR", "WP"}, new string[]{"right", "RB"}, new string[]{"right"}});
    //WHADJP
    nonTerminalInfo.Add("WHADVP", new String[][]{new string[]{"rightdis", "WRB", "WHADVP", "RB", "JJ"}}); // if not WRB or WHADVP, probably has flat NP structure, allow JJ for "how long" constructions
    ...
    nonTerminalInfo.Add("QP", new String[][]{new string[]{"right", "$", "NNS", "NN", "CD", "JJ", "PDT", "DT", "IN", "RB", "NCD", "QP", "JJR", "JJS"}});
    ...
    nonTerminalInfo.Add("S", new String[][]{new string[]{"left", "VP", "S", "FRAG", "SBAR", "ADJP", "UCP", "TO"}, new string[]{"right", "NP"}});

    nonTerminalInfo.Add("SBAR", new String[][]{new string[]{"left", "S", "SQ", "SINV", "SBAR", "FRAG", "VP", "WHNP", "WHPP", "WHADVP", "WHADJP", "IN", "DT"}});
    // VP shouldn't be needed in SBAR, but occurs in one buggy tree in PTB3 wsj_1457 and otherwise does no harm

    nonTerminalInfo.Add("SQ", new String[][]{new string[]{"left", "VP", "SQ", "ADJP", "VB", "VBZ", "VBD", "VBP", "MD", "AUX", "AUXG"}});


    // UCP take the first element as head
    nonTerminalInfo.Add("UCP", new String[][]{new string[]{"left"}});
    ...
    nonTerminalInfo.Add("CONJP", new String[][]{new string[]{"right", "CC", "VB", "JJ", "RB", "IN" }});
    ...
    nonTerminalInfo.Add("FRAG", new String[][]{new string[]{"left", "IN"}, new string[]{"right", "RB"}, new string[]{"left", "NP"}, new string[]{"left", "ADJP", "ADVP", "FRAG", "S", "SBAR", "VP"}});

    // PRN: sentence first
    nonTerminalInfo.Add("PRN", new String[][]{new string[]{"left", "VP", "SQ", "S", "SINV", "SBAR", "NP", "ADJP", "PP", "ADVP", "INTJ", "WHNP", "NAC", "VBP", "JJ", "NN", "NNP"}});
    ...
    nonTerminalInfo.Add("EMBED", new String[][]{new string[]{"right", "INTJ"}});
