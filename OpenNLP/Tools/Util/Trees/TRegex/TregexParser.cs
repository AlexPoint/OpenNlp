...
// pertains to this node gets passed all the way down to the Description node
  /*final*/ public DescriptionPattern Node(Relation r) /*throws ParseException */{
...
{if ("" != null) return node;}
  ...
  /*final*/ public DescriptionPattern Description(Relation r, bool negateDesc, bool cat) /*throws ParseException */{
      Token desc = null;
  Token name = null;
